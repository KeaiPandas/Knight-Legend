...
public class CloneSkillController : MonoBehaviour
{
    ...
    public void SetupClone(Transform _newTransform, float _cloneDuration, bool _canAttack, Vector3 _offset, Transform _cloestEnemy, bool _canDuplicate, Player _player)
    {
        if (_canAttack)
